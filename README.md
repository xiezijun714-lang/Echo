...
The primary launcher targets one node with 8 Blackwell B cards, using the Megatron backend and SGLang rollout. Before launching, export the required paths (scripts fail fast if these
are unset):
