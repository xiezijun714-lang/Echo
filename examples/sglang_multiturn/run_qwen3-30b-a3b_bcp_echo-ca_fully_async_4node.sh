...
#   TRAINER_IPS=ip1,ip2,ip3,ip4 bash examples/sglang_multiturn/run_qwen3-30b-a3b_bcp_echo-ca_fully_async_4node.sh
...
EXPERIMENT_NAME="qwen3-30b-a3b-bcp-echo-ca-fully-async-4node-32k-s5"
