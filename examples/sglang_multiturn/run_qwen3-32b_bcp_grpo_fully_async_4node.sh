...
#   bash examples/sglang_multiturn/run_qwen3-32b_bcp_grpo_fully_async_4node.sh
#
# Or pass an explicit 4-node slice:
#   TRAINER_IPS=ip1,ip2,ip3,ip4 bash examples/sglang_multiturn/run_qwen3-32b_bcp_grpo_fully_async_4node.sh
...
EXPERIMENT_NAME="qwen3-32b-bcp-grpo-fully-async-4node-32k"
