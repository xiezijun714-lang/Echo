...
Usage:
    ...
    python scripts/bcp/build_embed_index.py \
        --corpus_file /path/to/corpus.parquet \
        --model /path/to/model/Qwen3-Embedding-8B \
        --device cuda:0 \
        --batch_size 128 \
        --max_doc_length 8192 \
        --output /path/to/browsecomp_dense_cache_official.pkl
...
def main():
    ...
    parser.add_argument("--output", default="browsecomp_dense_cache_official.pkl")
