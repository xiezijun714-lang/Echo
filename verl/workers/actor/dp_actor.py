...
from verl.trainer.ppo.core_algos import agg_loss, get_policy_loss_fn, is_echo_turn_policy_loss, kl_penalty
...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        if "echo_turn_ids" in data.batch.keys():
            select_keys.append("echo_turn_ids")
        ...
        for _ in range(self.config.ppo_epochs):
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    policy_loss_kwargs = {}
                    if is_echo_turn_policy_loss(loss_mode):
                        policy_loss_kwargs["echo_turn_ids"] = model_inputs.get("echo_turn_ids", None)
